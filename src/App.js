  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/pakaian' element={<KategoriProduk banner={pakaian_banner}category="pakaian"/>}/>
        <Route path='/lainnya' element={<KategoriProduk banner={lainnya_banner}category="lainnya"/>}/>
        <Route path='/produk' element={<Produk/>}>
          <Route path=':productId' element={<Produk/>}/>
        </Route>
        <Route path='/keranjang' element={<Keranjang/>}/>
        <Route path='/masuk' element={<MasukRegister/>}/>
      </Routes>
      <Footer/>
      </BrowserRouter>
    </div>
